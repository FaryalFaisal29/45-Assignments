...
const OriginalArray: string[] = ["Eiffel Tower","Taj Mahal","Burj Khalifa","Spain","Grand Canyon"];

console.log(OriginalArray);

const sortedArray: string[] = [...OriginalArray];
...
const reversesortedArray: string[] = [...OriginalArray];
...
const OriginalArray1: string[] = ["Eiffel Tower","Taj Mahal","Burj Khalifa","Spain","Grand Canyon"];

OriginalArray.reverse();
 console.log("Reversed Array:", OriginalArray1);

const OriginalArray2: string[] = ["Eiffel Tower","Taj Mahal","Burj Khalifa","Spain","Grand Canyon"];

const reversesortedArray1: string[] = [...OriginalArray2];
